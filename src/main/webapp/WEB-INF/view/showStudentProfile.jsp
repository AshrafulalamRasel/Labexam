                        ...
                        <div class="col-10 text-center mt-3">
                            ...
                            <div class="table-responsive-md" id="table">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="studentregis" items="${studentRegistations}">
                                        <tr>
                                            <td>${studentregis.studentId}</td>
                                            <td>${studentregis.studentName}</td>
                                            <td>${studentregis.studentEmail}</td>
                                            <td>${studentregis.semestar}</td>
                                            <td>${studentregis.password}</td>
